    ...
    return {
      Courses: [
        ...
        },
        {
          id: 2,
          title: "Investing 101",
          description: "This course is about investing",
          category: "investing",
        },
        {
          id: 3,
          title: "Bitcoin",
          description: "An informational course about bitcoin",
          category: "money",
          subjects: [
            {
              id: 29,
            ...
            },
            {
              ...
              name: "Bitcoin",
              slide:
                "Peer-to-peer means no person in between you and the person you want to pay, or get paid from. Nowadays, if you pay at the supermarket, or one of your friends, the bank is the middleman. You have given the bank your money, they in return give (or used to give) you interest on it and when you make a payment, the bank sends this money to the right person(‘s bank account).",
            },
            {
              id: 2,
              name: "Bitcoin",
              slide:
                "In 2008, bitcoin was created by an unknow person/group known as Satoshi Nakamoto. It is based on cryptography and a distributed ledger, called a blockchain.",
            },
            {
              id: 3,
              name: "Bitcoin",
