    ...
    return {
      Courses: [
        {id: 1, title: "What is money?", description: "This course is about money and the history of money", category: "money", subjects: [
            ...
            {id: 23, name: "Inflation", slide: "../assets/slideImageInflation.png"},
